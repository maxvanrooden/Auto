...
if st.button("Bereken"):
    ...
    for jaar in jaren:
        ...
        st.write(f"👉 **Totaal zakelijk dat jaar:** €{round(afschrijving_per_jaar + brandstof_zakelijk_per_jaar + overige_per_jaar + bijtelling_per_jaar - btw_terug_jaar, 2)}")
